...
public class VerticalWheelView extends View {
    ...
    private static final int DP_DEFAULT_HEIGHT = 200;
    private static final int DP_DEFAULT_WIDTH = 32;
    ...
    private void readAttrs(AttributeSet attrs) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.VerticalWheelView);
        int marksCount = a.getInt(R.styleable.VerticalWheelView_marksCount, DEFAULT_MARKS_COUNT);
        drawer.setMarksCount(marksCount);
        int normalColor = a.getColor(R.styleable.VerticalWheelView_normalColor, DEFAULT_NORMAL_COLOR);
        drawer.setNormalColor(normalColor);
        int activeColor = a.getColor(R.styleable.VerticalWheelView_activeColor, DEFAULT_ACTIVE_COLOR);
        drawer.setActiveColor(activeColor);
        boolean showActiveRange = a.getBoolean(R.styleable.VerticalWheelView_showActiveRange,
                DEFAULT_SHOW_ACTIVE_RANGE);
        drawer.setShowActiveRange(showActiveRange);
        boolean snapToMarks = a.getBoolean(R.styleable.VerticalWheelView_snapToMarks, DEFAULT_SNAP_TO_MARKS);
        touchHandler.setSnapToMarks(snapToMarks);
        endLock = a.getBoolean(R.styleable.VerticalWheelView_endLock, DEFAULT_END_LOCK);
        onlyPositiveValues = a.getBoolean(R.styleable.VerticalWheelView_onlyPositiveValues,
