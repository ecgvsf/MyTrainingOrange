...
import static com.example.mytrainingorange.VerticalWheelView.VerticalWheelView.SCROLL_STATE_DRAGGING;
import static com.example.mytrainingorange.VerticalWheelView.VerticalWheelView.SCROLL_STATE_IDLE;
import static com.example.mytrainingorange.VerticalWheelView.VerticalWheelView.SCROLL_STATE_SETTLING;
...
class TouchHandler extends GestureDetector.SimpleOnGestureListener {
    ...
    private VerticalWheelView.Listener listener;
    private GestureDetector gestureDetector;
    private ValueAnimator settlingAnimator;
    private boolean snapToMarks;
    private int scrollState = SCROLL_STATE_IDLE;

    TouchHandler(VerticalWheelView view) {
        this.view = view;
        gestureDetector = new GestureDetector(view.getContext(), this);
    }

    void setListener(VerticalWheelView.Listener listener) {
