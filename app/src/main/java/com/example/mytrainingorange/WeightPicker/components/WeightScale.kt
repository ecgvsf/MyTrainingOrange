package com.example.mytrainingorange.WeightPicker.components
...
import com.example.mytrainingorange.WeightPicker.models.LineType
        ...
        onDraw = {
            ...
            for (i in minWeight..maxWeight) {
                ...
                val lineWidth = when (lineType) {
                    LineType.FiveStep -> style.fiveStepLineWidth.toPx()
                    LineType.Normal -> style.normalLineWidth.toPx()
                    LineType.TenStep -> style.tenStepLineWidth.toPx()
                }
